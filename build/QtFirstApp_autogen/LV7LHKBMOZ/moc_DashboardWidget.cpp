...
#include "../../../src/view/widgets/DashboardWidget.h"
...
void DashboardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->searchTriggered((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DashboardWidget::*)(const QString & , const QString & )>(_a, &DashboardWidget::searchTriggered, 0))
            return;
    }
}
...
// SIGNAL 0
void DashboardWidget::searchTriggered(const QString & _t1, const QString & _t2)
{
